...
namespace Blog.Controllers
{
    public class AdminController : Controller
    {
        ...
        {
            var newUser = new User(model.Name, model.Password, model.Email);
        ...
        public async Task<IActionResult> SavePost(PostViewModel model)
        {
            if (model.Image != null)
            {
                ...
                var newPost = new Post(model.Title, model.Resume, model.Content, imageToByte);
        ...
        )
        {
            ...
            var getPosts = await _postRepository.Get();
