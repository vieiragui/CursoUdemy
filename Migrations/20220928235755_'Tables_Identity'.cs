...
{
    public partial class Tables_Identity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName = table.Column<string>(type: "varchar(60)", maxLength: 60, nullable: true),
                    ...
                    SecurityStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoginProvider = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
                    ProviderKey = table.Column<string>(type: "varchar(40)", maxLength: 40, nullable: false),
